...
class Instructor extends Lambdasian {
  constructor(myObj){
    super(myObj);
    this.specialty = myObj.specialty;
    this.favLanguage = myObj.favLanguage;
    this.catchPhrase = myObj.catchPhrase;
  }
  ...
  gradeStudent(student){
    let score = Math.floor(Math.random() * 10) //STRETCH: creates random num between 1-10
    student.grade += score;
...
class Student extends Lambdasian{
  constructor(studentObj){
    ...
    this.grade = Math.floor(Math.random() * 100) + 1; //STRETCH: assigns grade to a random num 1-100
  }
